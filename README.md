...
My CV in [pdf](#). <!-- add link to your resume -->
...
Code: `Restaurant Data Analysis.sql` · Dashboard: `Restaurant_Dashboard.pbix`
...
Code: `Sleep_Health_Care_SQL.sql` · Dashboard: `Sleep & Life Health Care Analisis.pbix`
...
Code: `customer_behavior_sql_query.sql` · Dashboard: `Customer_Shopping.pbix`
...
- B.Com in Accounting and Finance — Government Arts, Commerce and Postgraduate College, Hassan, Karnataka

## Certificates

<!-- list certifications here, e.g. HackerRank SQL, Forage simulations, etc. -->
